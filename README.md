...
- ✅ Adicionar tarefas
- 🗑️ Remover tarefas
- ⭐ Marcar como favorita (com animação pulsante)
- ✔️ Marcar como concluída
- 💾 Persistência via `localStorage`
- 🎨 Interface responsiva com CSS customizado
- 🔧 Estado reativo com `useState` personalizado
...
- HTML5
- CSS3 (com `@keyframes` e media queries)
- JavaScript ES6+
...
1. Clone o repositório:
   ```bash
   git clone https://github.com/Peixoto1990/toDoList.git
2. Instale uma extensão de servidor local (recomendado: Live Server no VS Code)
